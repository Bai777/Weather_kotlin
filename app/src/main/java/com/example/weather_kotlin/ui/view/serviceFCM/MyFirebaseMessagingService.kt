package com.example.weather_kotlin.ui.view.serviceFCM
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMassageData.isNotEmpty()) {
            handleDataMessage(remoteMassageData.toMap())
        }

    }

    private fun handleDataMessage(toMap: Map<String, String>) {
        val title = toMap[PUSH_KEY_TITLE]
        val message = toMap[PUSH_KEY_MESSAGE]
