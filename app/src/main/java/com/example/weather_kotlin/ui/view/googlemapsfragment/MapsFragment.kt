package com.example.weather_kotlin.ui.view.googlemapsfragment
...
import com.example.weather_kotlin.databinding.FragmentMainMapsBinding
...
class MapsFragment : Fragment() {
    ...
    private fun activateMyLocation(map: GoogleMap) {
        context?.let {
